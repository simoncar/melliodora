...
class StoryForm extends Component {
  ...
  constructor(props) {
    ...
    let trackingOpts = {
      ...
      form: this.props.eventDate + ' - ' + this.props.eventTitle
    };

    Analytics.identify(global.username, trackingOpts);
    Analytics.track(Analytics.events.EVENT_FORM, trackingOpts);
    //analytics --------
  }
...
export default connect(mapStateToProps, bindAction)(StoryForm);
