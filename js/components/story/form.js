...
import { IconChat, IconShare, OrderOnPage, ShowOnHomeScreen } from "./formUtilities";
		...
		if (this.state.showAdvanced) {
			return (
				<View>
					...
					<ShowOnHomeScreen handler={this.handleHomeScreen} show={this.state.visible} />
				</View>
			);
		} else {
			return null;
					...
					onPress={() => {
						...
						if (_key == "") {
							...
							systemHero.logToCalendar(
								"StorySave-" + global.domain + summary,
								"Story Save - " + summary,
								global.domain,
